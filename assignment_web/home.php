            ...
            <div class="w3-content w3-section" style="max-width:500px">
                ...
                if (mysqli_num_rows($query) > 0) {
                    while ($row = mysqli_fetch_assoc($query)) { ?>
                        <img class="mySlides" src="./<?php echo $row['product_photo_link'] ?>" style="width:500px; height:350px">
                    <?php
                    } ?>
            </div>
        </div>
    ...
    <section id="about">
        <div class="container">
            <div class="col-md-8 col-md-offset-2">
                <div class="heading">
                    <h2>LUNU <span>SHOP</span></h2>
                    <div class="line"></div>
                    <p><span><strong>L</strong></span>UNU SHOP where the exprience of technology is revival</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="section-title">
                        ...
                        <div class="section-nav">
                            <ul class="section-tab-nav tab-nav">
                                <li class="active"><a data-toggle="tab" href="#tab1">ASUS</a></li>
                                <li><a data-toggle="tab" href="#tab2">DELL</a></li>
                                <li><a data-toggle="tab" href="#tab3">LENOVO</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
